		...
		this.editor.on("change",
			_.bind(
				function(cm, change) {
					...
					/*
						Paste action goes here... probably want a cm.operation()
						Zonelink handling code has been moved to "on save" but leaving
						this boilerplate for future paste handling.
					*/
