TextLab.PrimaryEditingView = Backbone.View.extend({
  ...
  render: function() {      
    ...
    this.tabbedEditor = new TextLab.TabbedEditor({ model: this.selectedLeaf, config: this.model.config, parentPanel: xmlEditorPanel, projectOwner: this.model.get('owner') });
